...
while 0 < 6:
    ...
    if _BLACKLIST.status_code != 200:
        ...
        blacklistyeppo = []
        break
    blacklistyeppo = _BLACKLIST.json()
    break
...
try:
    from YeppoBot.modules.sql_helper.globals import delgvar, gvarstatus
...
with bot:
    try:
        ...
        from YeppoBot.modules.sql_helper.bot_pms_sql import add_user_to_db, get_user_id
        from YeppoBot.modules.sql_helper.globals import addgvar, delgvar, gvarstatus
        from YeppoBot.yeppo import yeppoDB, HOSTED_ON, reply_id
        ...
        @tgbot.on(
            events.callbackquery.CallbackQuery(  # pylint:disable=E0602
                data=re.compile(f"reopen")
            )
        )
        async def on_reopen_plugin(event):
            if event.query.user_id == uid:
                ...
                await event.edit(
                    text,
                    file="https://telegra.ph/file/762510fa43ef987980d55.jpg",
                    buttons=buttons,
                    link_preview=False,
                )
            else:
            ...
            if event.query.user_id == uid and query.startswith(
                ...
                result = await event.builder.photo(
                    ...
                    buttons= [
                        ...
                        [
                            custom.Button.inline("ᴋᴇᴍʙᴀʟɪ", data="start"),
                        ],
                    ],
                )
                ...
                result = builder.article(
                    ...
                    buttons=[
                        [
                            ...
                            custom.Button.url(
                                "Sᴛʀɪɴɢ Rᴇᴘʟɪᴛ",
                                url="https://repl.it/@YeppoBot/yeppoString?lite=1&outputonly=1"),
                        ],
                        [
